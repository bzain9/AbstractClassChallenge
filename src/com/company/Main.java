...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // alphabetically). Duplicate values are not allowed.
        //
        ...
        //      again (if there is no next item than that is where the new item belongs).
        //
        ...
        // you create your classes before referring to them.
        //
        // Optional: create a class to use concrete class to implement a Binary Search Tree:
